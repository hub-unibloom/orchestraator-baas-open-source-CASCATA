...
import {
  ...
  Save, Database, Key, RefreshCw, Wand2, AlertTriangle, FileCode
} from 'lucide-react';
import GovernanceModal from '../components/storage/GovernanceModal';
...
const StorageExplorer: React.FC<{ projectId: string }> = ({ projectId }) => {
  ...
  // --- GOVERNANCE HELPERS moved to GovernanceModal component ---
  // See: ../components/storage/GovernanceModal.tsx
  ...
  return (
    ...
    >
      ...
      {/* GOVERNANCE ENGINE MODAL */}
      {/* NOTE: This modal is closely related to the Column Format Validation */}
      {/* system in DatabaseExplorer.tsx (Edit Format modal, Add Column format */}
      {/* presets) and TableCreatorDrawer.tsx (format generation). Both systems */}
      {/* share backend enforcement in DataController.ts. */}
      <GovernanceModal
        isOpen={showSettings}
